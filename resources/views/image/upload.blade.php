...
<link rel="stylesheet" href="{{ asset('fileupload/css/jquery.fileupload-ui.css') }}">
<!-- CSS adjustments for browsers with JavaScript disabled -->
<noscript><link rel="stylesheet" href="{{ asset('fileupload/css/jquery.fileupload-noscript.css') }}"></noscript>
<noscript><link rel="stylesheet" href="{{ asset('fileupload/css/jquery.fileupload-ui-noscript.css') }}"></noscript>
<div class="container">
...
{% for (var i=0, file; file=o.files[i]; i++) { %}
    <tr class="template-upload fade">
        ...
        <td>
            <p class="name">
              {!! Form::text('filetitle',null,['required','class' => 'form-control','placeholder'=>'Enter  your Custom Title..']) !!}
            </p>
            
        </td>
            <td>
            <p class="name">
             {!! Form::select('album_id', $types,null, ['class' => 'form-control'],'required') !!}
            </p>
        ...
        <td>
            <p class="name">
              {!! Form::select('filestatus', ['Public' => 'Public','Private' => 'Private'],null, ['class' => 'form-control'],'required') !!}
            </p>
        ...
        <td>
            <span class="preview">
                {% if (file.thumbnailUrl) { %}
                    <a href="{%=file.url%}" title="{%=file.name%}" download="{%=file.name%}" data-gallery><img width='50' height="50" src="{%=file.thumbnailUrl%}"></a>
                {% } %}
            </span>
        </td>
